...
$router->get('/notes/create', 'controllers/notes/create.php'); // NOTE: اگر کاربر صفحه (route) /notes/create رو با GET درخواست کرد برو منطقی که در controller/n otes/create.php هستش رو اجرا کن
